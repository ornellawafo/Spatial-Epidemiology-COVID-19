...
usual_code <- nimbleCode({ 
  ...
  sigma2 ~ dinvgamma(1, 0.01)     # Full conditional will be IG known dist, makes MCMC easier
...
Inits_usual <- list(beta0 = 1, 
                    beta = rep(1, ncol(data.clean[5:18])), 
                    sigma2 = 1, 
...
plot(usual01_samples[, "beta[1]"], type = "l")

# Plot the density curves for posterior
plot(density(usual01_samples[,"beta[1]"])) # Why are all beta's = 1
plot(density(usual01_samples[,"beta[2]"]))
plot(density(usual01_samples[,"beta[3]"]))
plot(density(usual01_samples[,"beta[4]"]))
plot(density(usual01_samples[,"beta[5]"]))
plot(density(usual01_samples[,"beta[6]"]))
plot(density(usual01_samples[,"beta[7]"]))
plot(density(usual01_samples[,"beta[8]"]))
plot(density(usual01_samples[,"beta[9]"]))
plot(density(usual01_samples[,"beta[10]"]))
plot(density(usual01_samples[,"beta[11]"]))
plot(density(usual01_samples[,"beta[12]"]))
plot(density(usual01_samples[,"beta[13]"]))
plot(density(usual01_samples[,"beta[14]"]))
plot(density(usual01_samples[,"sigma2"]))
plot(density(usual01_samples[,"s[1]"])) # Why are all of the s's the exact same shape
plot(density(usual01_samples[,"s[2]"]))
plot(density(usual01_samples[,"s[3]"]))
plot(density(usual01_samples[,"s[4]"]))
plot(density(usual01_samples[,"s[5]"]))
plot(density(usual01_samples[,"s[6]"]))
plot(density(usual01_samples[,"s[7]"]))
plot(density(usual01_samples[,"s[8]"]))
plot(density(usual01_samples[,"s[9]"]))
plot(density(usual01_samples[,"s[10]"]))
plot(density(usual01_samples[,"s[11]"]))
plot(density(usual01_samples[,"s[12]"]))
plot(density(usual01_samples[,"s[13]"]))
plot(density(usual01_samples[,"s[14]"]))
plot(density(usual01_samples[,"s[15]"]))
plot(density(usual01_samples[,"s[16]"]))
plot(density(usual01_samples[,"s[17]"]))
plot(density(usual01_samples[,"s[18]"]))
...
```{r}
# Neighborhood structure 3: 1/euclidean distance neighbourhood ###############################################
