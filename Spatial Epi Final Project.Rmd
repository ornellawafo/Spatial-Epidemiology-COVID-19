...
# Fitted values - distribution
fitted_usual02_dist <- data.clean$Expected * exp(fitted_usual02)

# Mean fitted SIR
fitted_SIR_usual02 <- exp(apply(fitted_usual02, 2, mean))

# Mean fitted Cases
fitted_usual02 <- fitted_SIR_usual02*data.clean$Expected
...
fitted_usual02_df <- data.frame("Observed SIR"   =  round(data.clean$SIR, 2), 
                                ...
                                "Observed Cases" =  round(data.clean$Cases), 
                                "Fitted Cases" =  round(fitted_usual02), 
...
# Fitted values - distribution
fitted_usual03_dist <- data.clean$Expected * exp(fitted_usual03)
...
# Mean fitted Cases
fitted_usual03 <- fitted_SIR_usual03*data.clean$Expected
...
fitted_usual03_df <- data.frame("Observed SIR"   =  round(data.clean$SIR, 2), 
                                ...
                                "Observed Cases" =  round(data.clean$Cases), 
                                "Fitted Cases" =  round(fitted_usual03), 
...
# Mean fitted Cases
fitted_bym_usual01 <- fitted_SIR_bym_usual01*data.clean$Expected
...
fitted_bym_usual01_df <- data.frame("Observed SIR"   =  round(data.clean$SIR, 2), 
                                ...
                                "Observed Cases" =  round(data.clean$Cases), 
                                "Fitted Cases" =  round(fitted_bym_usual01), 
...
# Mean fitted Cases
fitted_bym_usual02 <- fitted_SIR_bym_usual02*data.clean$Expected
...
fitted_bym_usual02_df <- data.frame("Observed SIR"   =  round(data.clean$SIR, 2), 
                                ...
                                "Observed Cases" =  round(data.clean$Cases), 
                                "Fitted Cases" =  round(fitted_bym_usual02), 
...
# Fitted values - distribution
fitted_bym_usual03_dist <- data.clean$Expected * exp(fitted_bym_usual03)
...
# Mean fitted Cases
fitted_bym_usual03 <- fitted_SIR_bym_usual03*data.clean$Expected
...
# Loop to generate fitted values: log(ri)
for(i in 1:nrow(data.clean)){
  fitted_ridge01[,i] = ridge01_samples[,"beta0"] + as.matrix(data.clean[i,5:ncol(data.clean)]) %*%t(ridge01_samples[,1:8]) + 
    ridge01_samples[, 10+i-1] 
...
# Loop to generate fitted values: log(ri)
for(i in 1:nrow(data.clean)){
  fitted_ridge02[,i] = ridge02_samples[,"beta0"] + as.matrix(data.clean[i,5:ncol(data.clean)]) %*%t(ridge02_samples[,1:8]) + 
    ridge02_samples[, 10+i-1] 

}

# Fitted values - distribution
fitted_ridge_02_dist <- data.clean$Expected * exp(fitted_ridge02)
...
# 95% CrI SIR
fitted_ridge_02_CrI_SIR <- t(exp(apply(fitted_ridge02, 2, function(x) quantile(x, probs=c(0.025, 0.975)))))
