...
```{r  BYM Adjacency, echo = F, results = F, message = F}
# Defining the data that goes into the model ----------------------------------------------------------------
...
```{r usual Ridge code, echo = F, results = F, message = F}
#########################################
...
```{r Ridge Adjacency Fitted Values}
# (11) Fitted values -----------------------------------------------------------------------------
...
```{r Ridge Adjacency Density Plots}
