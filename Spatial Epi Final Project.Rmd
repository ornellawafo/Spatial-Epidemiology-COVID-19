...
Consts_usual_01 = list(N = nrow(data.clean),                  # Number of areas
                       p = ncol(data.clean[5:13]),            # Number of covariates
                       X = as.matrix(data.clean[, c(5:13)]),  # Matrix of covariates
...
Inits_usual <- list(beta0 = 1351,
                    beta = rep(0, ncol(data.clean[, 5:13])), 
                    #sigma2 = 10, 
                    tau2 = 0.3137,
