...
cbind(fitted_ridge03_df[,4:6],fitted_ridge01_df[,4:6])
```
...
WAIC.Ridge.bymCAR <- cbind(Adjescent = ridge01_bym_runMCMC$WAIC,  K3= ridge01_bym_runMCMC$WAIC,  K5 = ridge01_bym_runMCMC$WAIC)
WAIC.Ridge.bymCAR
