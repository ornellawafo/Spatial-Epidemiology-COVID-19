...
ridge_code <- nimbleCode({ 
  ...
  for(j in 1:p){
    beta[j] ~ dnorm(0, sd=nu*sqrt(1/lambda))  # Betas for the covariates
  }
   nu ~ T(dt(0, 1, 1),0,) 
...
ridge01_model=nimbleModel(code=ridge_code, constants=Consts_ridge_01, data=outcome, inits=Inits_ridge)
