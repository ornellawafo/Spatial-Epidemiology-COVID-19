...
poi.fit <- glm(Cases ~ . - District - SIR + offset(log(Expected)), data = data.clean, family = poisson(link="log"))
summary(poi.fit)
...
means_betas_usual_01 <- apply(usual01_samples[,1:6],2, mean)

#Calculating the Beta 95% CrI 
CrI_betas_usual_01 <- t(apply(usual01_samples[ ,1:6],2, function(x) quantile(x, probs=c(0.025,0.975))))
...
for(i in 1:nrow(data.clean)){
  fitted_usual01[,i] = usual01_samples[,"beta0"] + as.matrix(data.clean[i,5:ncol(data.clean)]) %*% t(usual01_samples[,1:6]) + usual01_samples[, 8+i-1] 
...
# Mean fitted values
fitted_usual_01 <- apply(test, 2, mean)

# 95% CrI
fitted_usual_01_CrI <- t(apply(test, 2, function(x) quantile(x, probs=c(0.025, 0.975))))
...
#Calculating the Beta means
means_betas_usual_02=apply(usual02_samples[,1:6],2, mean)

#Calculating the Beta 95% CrI 
CrI_betas_usual_02=t(apply(usual02_samples[ ,1:6],2, function(x) quantile(x, probs=c(0.025,0.975))))
...
#Loop to generate fitted values: log(ri)
for(i in 1:nrow(data.clean)){
  fitted_usual02[,i] = usual02_samples[,"beta0"] + as.matrix(data.clean[i,5:ncol(data.clean)]) %*% t(usual02_samples[,1:5]) + usual02_samples[, 7+i-1] 
...
# Mean fitted values
fitted_usual_02 <- apply(test, 2, mean)

# 95% CrI
fitted_usual_02_CrI <- t(apply(test, 2, function(x) quantile(x, probs=c(0.025, 0.975))))
...
#Calculating the Beta means
means_betas_usual_03=apply(usual03_samples[,1:6],2, mean)

#Calculating the Beta 95% CrI 
CrI_betas_usual_03=t(apply(usual03_samples[ ,1:6],2, function(x) quantile(x, probs=c(0.025,0.975))))
...
#Loop to generate fitted values: log(ri)
for(i in 1:nrow(data.clean)){
  fitted_usual03[,i] = usual03_samples[,"beta0"] + as.matrix(data.clean[i,5:ncol(data.clean)]) %*% t(usual03_samples[,1:5]) + usual03_samples[, 7+i-1] 
...
# Mean fitted values
fitted_usual_03 <- apply(test, 2, mean)

# 95% CrI
fitted_usual_03_CrI <- t(apply(test, 2, function(x) quantile(x, probs=c(0.025, 0.975))))
...
#Betas
#Calculating the Beta means
means_betas_bym_usual01 <- apply(bym_usual01_samples[,1:6],2, mean)

#Calculating the Beta 95% CrI 
CrI_betas_bym_usual01 <- t(apply(bym_usual01_samples[ ,1:6],2, function(x) quantile(x, probs=c(0.025,0.975))))
...
#Calculating the Beta 95% CrI 
CrI_v_bym_usual01 <- t(apply(bym_usual01_samples[ ,27:ncol(bym_usual01_samples)],2, function(x) quantile(x, probs=c(0.015,0.975))))
...
#Calculating the Beta 95% CrI 
CrI_beta0_bym_usual01 <- t(quantile(bym_usual01_samples[ , 7], probs=c(0.015,0.975)))
...
# Mean fitted values
fitted_bym_usual_01 <- apply(test, 2, mean)

# 95% CrI
fitted_bym_usual_01_CrI <- t(apply(test, 2, function(x) quantile(x, probs=c(0.025, 0.975))))
...
#Betas
#Calculating the Beta means
means_betas_bym_usual02 <- apply(bym_usual02_samples[,1:6],2, mean)

#Calculating the Beta 95% CrI 
CrI_betas_bym_usual02 <- t(apply(bym_usual02_samples[ ,1:6],2, function(x) quantile(x, probs=c(0.025,0.975))))
...
for(i in 1:nrow(data.clean)){
  fitted_bym_usual02[,i] = bym_usual02_samples[,"beta0"] 
                      + as.matrix(data.clean[i,5:ncol(data.clean)]) %*% t(bym_usual02_samples[,1:5])
...
# Mean fitted values
fitted_bym_usual_02 <- apply(test, 2, mean)

# 95% CrI
fitted_bym_usual_02_CrI <- t(apply(test, 2, function(x) quantile(x, probs=c(0.025, 0.975))))
...
#Betas
#Calculating the Beta means
means_betas_bym_usual03 <- apply(bym_usual03_samples[,1:6],2, mean)

#Calculating the Beta 95% CrI 
CrI_betas_bym_usual03 <- t(apply(bym_usual03_samples[ ,1:6],2, function(x) quantile(x, probs=c(0.025,0.975))))
...
for(i in 1:nrow(data.clean)){
  fitted_bym_usual03[,i] = bym_usual03_samples[,"beta0"] 
                      + as.matrix(data.clean[i,5:ncol(data.clean)]) %*% t(bym_usual03_samples[,1:5])
...
# Mean fitted values
fitted_bym_usual_03 <- apply(test, 2, mean)

# 95% CrI
fitted_bym_usual_03_CrI <- t(apply(test, 2, function(x) quantile(x, probs=c(0.025, 0.975))))
