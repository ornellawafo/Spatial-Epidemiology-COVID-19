...
```{r}
# Neighborhood structure 1: Adjacency matrix #################################################
...
Consts_usual_01 = list(N = nrow(data.clean),                  # Number of areas
                       ...
                       num = num.nb,                          # N of neighbors per district
                       weights = rep(1, length(adj)))         # Weight of 1 for neighbors
...
usual01_model <- nimbleModel(code = usual_code, 
                             constants = Consts_usual_01, 
                             data = outcome, 
                             inits = Inits_usual)
...
```{r}
# Neighborhood structure 2: Distance-based (k = 3) ###########################################
...
# (1) Define the usual fixed prior model for nimble
usual02_model <- nimbleModel(code = usual_code, 
                             constants = Consts_usual_02, 
                             data = outcome, 
                             inits = Inits_usual_02)
...
# Combining the means and CIs into a dataframe
mean_CrI_betas_usual_02 <- t(matrix(c(means_betas_usual_02, CrI_betas_usual_02), ncol=14, byrow=T)) %>% as.data.frame()
...
# Neighborhood structure 3: Distance-based (k = 5) ###########################################
...
# (1) Define the usual fixed prior model for nimble
usual03_model <- nimbleModel(code = usual_code, 
                             constants = Consts_usual_03, 
                             data = outcome, 
                             inits = Inits_usual_03)
...
# Calculating the Beta 95% CrI 
CrI_beta0_usual_03 <- t(quantile(usual03_samples[ , 15], probs=c(0.035,0.975)))
...
Inits_usual_bym_01 <- list(
                           ...
                           sigma2 = 1, 
                           s = rnorm(num.nb), # S sampled from N dist (do we sample ours from poisson?)
                           v = rep(0, nrow(data.clean))) # IG istribution?


# Defining model -----------------------------------------------------------------------------

# (1) Define the usual fixed prior model for nimble
bym_usual01_model <- nimbleModel(code = usual_code_bym, 
                                 constants = Consts_usual_bym_01, 
                                 data = outcome, 
                                 inits = Inits_usual_bym_01)
...
# (1) Define the usual fixed prior model for nimble
bym_usual02_model <- nimbleModel(code = usual_code_bym, 
                                 constants = Consts_usual_bym_02, 
                                 data = outcome, 
                                 inits = Inits_usual_bym_02)
...
Consts_usual_bym_03 = list(N = nrow(data.clean),              # Number of areas
                       ...
                       num = num.nb.5,                        # Number of neighbors per district
                       weights = rep(1, length(adj.5)))       # Giving weight of 1 for neighbors
>>>>>>> 8e0b0cdd30661cc83bc938a1ed1862d9817a9e93
...
# (1) Define the usual fixed prior model for nimble
bym_usual03_model <- nimbleModel(code = usual_code_bym, 
                                 constants = Consts_usual_bym_03, 
                                 data = outcome, 
                                 inits = Inits_usual_bym_03)
>>>>>>> 8e0b0cdd30661cc83bc938a1ed1862d9817a9e93
...
#Calculating the Beta 95% CrI 
CrI_betas_bym_usual03 <- t(apply(bym_usual03_samples[ ,1:14],2, function(x) quantile(x, probs=c(0.035,0.975))))
...
#Calculating the Beta 95% CrI 
CrI_s_bym_usual03 <- t(apply(bym_usual03_samples[ ,15:32],2, function(x) quantile(x, probs=c(0.035,0.975))))
...
#Calculating the Beta 95% CrI 
CrI_v_bym_usual03 <- t(apply(bym_usual03_samples[ ,34:ncol(bym_usual03_samples)],2, function(x) quantile(x, probs=c(0.035,0.975))))
...
#Calculating the Beta 95% CrI 
CrI_beta0_bym_usual03 <- t(quantile(bym_usual03_samples[ , 15], probs=c(0.035,0.975)))
