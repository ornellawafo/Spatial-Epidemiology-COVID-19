...
for(i in 1:nrow(data.clean)){
  fitted_usual01[,i] = usual01_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(usual01_samples[,1:14]) +
...
#Loop to generate fitted values
for(i in 1:nrow(data.clean)){
  fitted_usual02[,i] = usual02_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(usual02_samples[,1:14]) +
...
#Loop to generate fitted values
for(i in 1:nrow(data.clean)){
  fitted_usual03[,i] = usual03_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(usual03_samples[,1:14]) +
...
#Loop to generate fitted values
for(i in 1:nrow(data.clean)){
  fitted_bym_usual01[,i] = bym_usual01_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(bym_usual01_samples[,1:14]) +
...
#Loop to generate fitted values
for(i in 1:nrow(data.clean)){
  fitted_bym_usual02[,i] = bym_usual02_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(bym_usual02_samples[,1:14]) + 
...
#Loop to generate fitted values
for(i in 1:nrow(data.clean)){
  fitted_bym_usual03[,i] = bym_usual03_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(bym_usual03_samples[,1:14])  +
...
# (3) Define initial values for the MCMC chain
Inits_ridge <- list(beta0=1, beta=rep(0, ncol(data.clean[5:18])),
...
#Loop to generate fitted values
for(i in 1:nrow(data.clean)){
  fitted_ridge01[,i]=ridge01_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(ridge01_samples[,1:14]) + ridge01_samples[,17+i]
}
...
#Loop to generate fitted values
for(i in 1:nrow(data.clean)){
  fitted_ridge02[,i]=ridge02_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(ridge02_samples[,1:14]) + ridge02_samples[,17+i]
}
...
#Loop to generate fitted values
for(i in 1:nrow(data.clean)){
  fitted_ridge03[,i]=ridge03_samples[,"beta0"] + as.matrix(data.clean[i,5:18]) %*% t(ridge03_samples[,1:14]) + ridge03_samples[,17+i]
}
